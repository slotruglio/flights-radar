...
from utils.trip import get_flights
...
for flight in result:
	transfer = {}
	transfer["departure_trains"] = get_trenitalia_fare(origin_city[0], flight.origin, flight.departure_date.strftime('%Y-%m-%d'))
	transfer["arrival_trains"] = get_trenitalia_fare(flight.destination, destination_city[0], flight.departure_date.strftime('%Y-%m-%d'))
